...
During testing on multiple mobile devices (iPone 5(SE), iPhone 12 Pro, iPad mini, Galaxy S20 ultra), there was a good response on all devices within **Chrome developer tools**, but I found that on the iPad mini. it showed that the Registered Address title was bigger on the Classes and Contact pages. When checking the Lighthouse performance it showed that the headings elements were not in a sequentially-descending order so when I changed this I made the heading for the footer on these pages a h3 and with a class of h4 from Bootstrap but the font-weight was higher. To make them respond in the same way as the Home page I added the selector of '#registered-marks h3' to the h4 on the stylesheet to achieve this.

When I created a mochup of the website on [**Am I Responsive**](https://ui.dev/amiresponsive), the **Navbar** on the mobile appeared on 2 lines, which happens when the screen is less than 300px. This was fixed by adding a **@media query** for mobile with a screen size smaller than 315px (it is slightly smaller than the most commonly used small screen of the iPhone 5 at 320px). This will remove the home link from displaying, which will not cause any problems as the logo has a link to the home screen which people are aware of nowadays. When testing this out on a Galaxy fold I found that although I had added the @media query and an id="home-link" to the home page I forgot about the other pages so have now included it and it is working correctly.

Within Chrome's developer tools I also tested the larger screens of 4K screen of 2560px and the iMac Pro of 5120px which showed the site taking up about 30% of the screen. As there is a lot of real estate to take up I created a maximum width of 2400px and to centralise the view of the site. The 4K screen has about 10% of white space on either side on all the sites pages, with 5% at the bottom on the Home screen, the classes and the Shop page about the same but doesn't stand out as much because the background is white, but the Contact page shows no white space at the bottom. The 5K screen shows about 30% of white screen on either side of the site for all the pages, but with the Home page there is approximately 50%, the Classes page shows 1/3, Shop page about 5% and the Contact page has no white space at the bottom of the site. While testing the responsiveness of the site on the large screens I also noticed that the navbar menu was disappearing to the right of the screen. This was due to the header being fixed, so it was not responding to the changes of the body's fixed width. So, a max-width was put on the header as well, now you can see the menu within the bounds of the sites screen width.
...
After making further adjustments to the site I re-tested the HTML and CSS with the W3C validators again and they showed no errors.

****

- ### Lighthouse

When looking at the performance, accessibility, best practices and the SEO of the website, I used **Lighthouse** in Chrome's development tools. The main downfall of the site is in it performance as the photos were not of the correct size in both height and width, in megabytes, and format. They also need to be more responsive over the different sizes of screens. This has caused lagging on the site when loading and linking to the other pages.

- This has been looked at by modifying the images by adjusting the size, height and width, and format (see Browser Compatability).
- The problem is still showing, not so much, but is still taking approximately 5 seconds to load on mobiles.
...
After modifying the images on the site and further adjustments and styling to the pages, I re-analysed the performance, accessibility, best practices and the SEO of the website in Lighthouse, which is part of Chrome's Developer tools, which gave the following results:
...
- As a visitor to the gym, I want to know when the gym is open so that I know when I can use the gym.
    - The Home page has the opening times which includes the days of the week the gym is open with 2 call to action buttons to the Classes or Contact Us page.
    - The Classes page can be view to check on the times that the classes are run with the Timetable at the bottom of the page.
...
- As a first time visitor to the gym, I want to use the gym but I have no idea how to use the equipment. Where do I start.
    ...
    - He can get further information on the classes and see what the gym looks like from the photos on the Classes page and throughout the site.
...
- As a middle aged woman, I want a place to go where I don't feel intimidated when I exercise and ladies only events.
    ...
    - The Timetable at the bottom of the Classes page, gives the times of classes available.
...
- As a new user of the site, I want to be able to see what other people say about the gym.
...
- As a user of the site, I want to know what classes are available and book them.
    ...
    - From the Classes page the user can click on the Contact Us button to be able to book a session.
...
- ### Home Page:
    - Navigation bar
        ...
        - Check when hovered over the text, to see that the title "Link back Home" appears.
        ...
        - Verify the responsiveness of the navigation bar on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools.
        ...
        - Verify the responsiveness of the menu not showing the home link, on mobiles smaller than the 320px per the Chrome's developer tools (Galaxy fold 270px).
    - Hero image and cover text
        - Verify the responsiveness of the image and text on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools.
    ...
    - Main section
        - Verify the responsiveness of the images and text on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools, from single column on mobiles, 2 columns on tablet, 3 columns on smaller laptops, 4 columns on larger laptops and larger screens.
            - On the 4K and 5K screens the site only covered about 30% of the screen, so a max-width was added to fix this.
        - Click on the call to action buttons (See Classes and Contact Us) to check that they go to the correct page from the Home screen.
    ...
    - Footer
        ...
        - Make sure that each icon clicked opens up in a new window, using the **target="_blank".
        - Hover over the icon to its responiveness on laptops and desktops.
        - Verify the responsiveness of the Footer on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools.
- ### Classes Page:
    - Navigation bar
        - Clicked on each menu item (Home, Shop, Contact) to verify that it goes to the correct page from the Classes screen.
        - Clicked on the logo to see that it goes back to the Home screen.
        - Hover over logo for responsiveness on laptops and desktops. 
            - There is no explanation as to why it is a link, so I have added a title attribute to the logo to remedy this.
        - Check when hovered over the text, to see that the title "Link back Home" appears.
        ...
        - Verify the responsiveness of the menu not showing the home link, on mobiles smaller than the 320px per the Chrome's developer tools (Galaxy fold 270px).
    - Main section
        - Verify the responsiveness of the images and text on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools, from single column on mobiles, 2 columns on tablet, 3 columns on smaller laptops, 4 columns on larger laptops, 6 columns on 1800px screen width, 7 columns on larger screens.
        - Verify the responsiveness of the Timetable on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools. 
        - Click on the call to action button Contact Us to check that they go to the correct page from the Classes screen.
    ...
    - Footer
        ...
        - Hover over the icon to its responiveness on laptops and desktops.
        - Verify the responsiveness of the Footer on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools.
            - The title Registered Address was bigger than it should be, so was changed to match the Home screen.
- ### Shop
    - Navigation bar
        - Clicked on each menu item (Home, Classes, Contact) to verify that it goes to the correct page from the Shop screen.
        - Clicked on the logo to see that it goes back to the Home screen.
        - Hover over logo for responsiveness on laptops and desktops. 
            - There is no explanation as to why it is a link, so I have added a title attribute to the logo to remedy this.
        - Check when hovered over the text, to see that the title "Link back Home" appears.
        ...
        - Verify the responsiveness of the menu not showing the home link, on mobiles smaller than the 320px per the Chrome's developer tools (Galaxy fold 270px).
    - Main section
        - Verify the responsiveness of the images and text on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools, from 2 columns on mobiles and tablet, 4  columns on laptops and larger screens.
        - The text is a Shiva Blue colour on the Dynamo background colour, but failed on the contrast of colours. I found that the site was picking up on Bootstraps colour     Blue Raspberry and not mine.
            - To get the better contrast ratio I changed all the font colours to white.
    - Footer
        - Click on each icon to see that they go to the link address.
        - Make sure that each icon clicked opens up in a new window, using the **target="_blank".
        - Hover over the icon to its responiveness on laptops and desktops.
...
- ### Contact Us Page
    - Navigation bar
        - Clicked on each menu item (Home, Classes, Shop) to verify that it goes to the correct page from the Contact screen.
        - Clicked on the logo to see that it goes back to the Home screen.
        - Hover over logo for responsiveness on laptops and desktops. 
            - There is no explanation as to why it is a link, so I have added a title attribute to the logo to remedy this.
        - Check when hovered over the text, to see that the title "Link back Home" appears.
        ...
        - Verify the responsiveness of the menu not showing the home link, on mobiles smaller than the 320px per the Chrome's developer tools (Galaxy fold 270px).
    - Main section
        - Verify the responsiveness of the image and form on mobiles, tablets, laptops, 4K and 5K screens on Chrome's developer tools.
        - Hover over the call to action button to check the responsiveness and that they change colour.
        ...
        - Click the call to action submit button to see that the information is received by Code Institute (see image below) after all fields are filled in correctly.
    - Footer
        - Click on each icon to see that they go to the link address.
        - Make sure that each icon clicked opens up in a new window, using the **target="_blank".
        - Hover over the icon to its responiveness on laptops and desktops.
...
### Further testing
- I viewed the site on my own mobile (Huawei P30 Pro: Chrome) and the Navigation bar appeared in full and there was only the lagging of the photos on each page. When I tested it again (after the image changes) I found that I had no problems with clicking on the links and the loading of the pages.
...
When the fields on the Contact Us form was filled in no pop-up messages appeared to make sure that the user input information into all the fields. I included the **required** attribute to all the fields on the form so that the pop-up message to prompt the user to fill all the field in appears and that the email address is filled in correctly in the right format. Once the user completed the form what was sent to the gym includes everything the gym needs to contact them. 
...
During the Lighthouse tests the contrast ratio between the foreground and the background was not sufficient on the performance of the Shop page. Although I had changed the text colour to Shiva Blue it was actually picking up on Bootstraps blue colour, but it still gave the same problem with the contrast.
- After looking on [Deque University's](https://dequeuniversity.com/rules/axe/4.10/color-contrast) to see if there was a way to use the colour of the site by changing the density, but the contrast colour still did not improve. As I could not keep the colours I was using, my best option was to change the text to white with Dynamo as the background colour, which gave a good contrast ratio.

During the Lighthouse tests the performance of the images was slowing up the loading of the site to the landing page and also when navigating to the other pages, by a considerable amount. This was due to the photos not being of the correct size in both height and width, in megabytes, and format.

- I altered the images to reduce the lagging effect, as per the [Imagery](README.md#imagery) in the READMe.md file. This went a long way to reducing the problem on the larger screens.
- The problem is still showing on the mobile taking approximately 5 seconds to load.